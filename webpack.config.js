// Webpack configuration for napari-sphinx-theme.
//
...
function macroTemplate({ compilation }) {
  ...
  const css_files = ['styles/theme.css', 'styles/napari-sphinx-theme.css']
  const js_files = ['scripts/napari-sphinx-theme.js']
        ...
        use: [
          {
            loader: 'file-loader',
            options: {
              name: 'styles/napari-sphinx-theme.css',
            },
          },
          {
